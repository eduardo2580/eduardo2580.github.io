...
(function () {
    ...
    // bump suffix to reset all progress
...
/* ── Fade-in animation ───────────────────────────────────────── */
/* ── Backup trigger button (inline, compact) ─────────────────── */
.teens-backup-trigger {
    display: flex;
    align-items: center;
    justify-content: space-between;
    gap: 0.75rem;
...
.teens-backup-trigger:hover {
    background: rgba(155, 109, 255, 0.1);
    border-color: rgba(155, 109, 255, 0.5);
}
.teens-backup-trigger-left {
    display: flex;
    align-items: center;
    gap: 0.6rem;
}
.teens-backup-trigger-icon {
    width: 32px;
    height: 32px;
    border-radius: 8px;
    background: rgba(155, 109, 255, 0.12);
...
.teens-backup-trigger-text strong {
    display: block;
    font-size: 0.85rem;
    font-weight: 700;
    color: var(--bs-body-color, #111);
}
.teens-backup-trigger-text span {
    font-size: 0.72rem;
    color: var(--bs-secondary-color, rgba(0,0,0,0.5));
}
.teens-backup-trigger-chevron {
...
.teens-backup-overlay.open .teens-backup-sheet {
...
.teens-backup-sheet-title {
    font-size: 1.2rem;
    font-weight: 800;
    letter-spacing: -0.02em;
    margin: 0 0 0.25rem;
}
.teens-backup-sheet-sub {
    font-size: 0.8rem;
    color: var(--bs-secondary-color, rgba(0,0,0,0.5));
    margin: 0 0 1.5rem;
}
...
.teens-backup-card-header {
    display: flex;
    align-items: center;
    gap: 0.75rem;
    padding: 1rem 1.1rem 0.6rem;
}
.teens-backup-card-icon {
    width: 38px;
    height: 38px;
    border-radius: 10px;
    display: flex;
...
.teens-backup-card-icon.export { background: rgba(124,58,237,0.1); color: #7c3aed; }
.teens-backup-card-icon.import { background: rgba(16,185,129,0.1); color: #059669; }
.teens-backup-card-title {
    font-size: 0.95rem;
    font-weight: 700;
    margin: 0 0 0.1rem;
}
.teens-backup-card-desc {
    font-size: 0.76rem;
    color: var(--bs-secondary-color, rgba(0,0,0,0.5));
    margin: 0;
}
.teens-backup-card-body {
...
.btn-backup-action.primary {
    background: linear-gradient(135deg, #7c3aed, #9b6dff);
    color: #fff;
    box-shadow: 0 3px 14px rgba(123,58,237,0.28);
}
.btn-backup-action.primary:hover { transform: translateY(-1px); box-shadow: 0 5px 18px rgba(123,58,237,0.38); }
.btn-backup-action.secondary {
    background: rgba(124,58,237,0.07);
    color: #7c3aed;
    border: 1px solid rgba(124,58,237,0.2);
}
.btn-backup-action.secondary:hover { background: rgba(124,58,237,0.12); }
.btn-backup-action.success {
    background: linear-gradient(135deg, #059669, #10b981);
    color: #fff;
    box-shadow: 0 3px 14px rgba(5,150,105,0.25);
}
.btn-backup-action.success:hover { transform: translateY(-1px); box-shadow: 0 5px 18px rgba(5,150,105,0.35); }
...
.teens-drop-zone:hover,
.teens-drop-zone.drag-over {
    border-color: #10b981;
    background: rgba(16,185,129,0.08);
}
.teens-drop-zone input[type=file] {
    position: absolute;
    inset: 0;
    opacity: 0;
    cursor: pointer;
...
.teens-drop-zone-icon {
    font-size: 1.75rem;
    color: #10b981;
    margin-bottom: 0.4rem;
}
.teens-drop-zone-text {
    font-size: 0.85rem;
    font-weight: 600;
    color: var(--bs-body-color, #111);
    margin: 0 0 0.2rem;
}
.teens-drop-zone-hint {
    font-size: 0.72rem;
    color: var(--bs-secondary-color, rgba(0,0,0,0.45));
    margin: 0;
}
